...
public class _05_ASCII {
    public static void main(String[] args) {
        ...
        // 퀴즈 5번
        // 배열을 활용하여 쇼핑몰에서 구매 가능한 신발 사이즈 옵션을 출력하는 프로그램을 작성하시ㅗ
        // 조건
        // 신발 사이즌느 250부터 295 까지 5 단위로 증가
        // 신발 사이즈 수는 총 10가지
        // ㅈㅈㅈㅈㅈ망

//        int[][] shoe = new int[10][15];
//        for (int i = 250; i < shoe.length; i++) {
